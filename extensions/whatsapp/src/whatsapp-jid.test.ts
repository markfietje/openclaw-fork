...
import { areSameWhatsAppJid, classifyWhatsAppJid, encodeWhatsAppJid } from "./whatsapp-jid.js";
...
describe("classifyWhatsAppJid", () => {
  ...
  it.each([
    ...
    "15551230000_128:1@s.whatsapp.net",
    "15551230000 :1@s.whatsapp.net",
...
describe("areSameWhatsAppJid", () => {
  it("compares canonical identities only within the same JID class", () => {
    ...
    expect(areSameWhatsAppJid("15551230000@hosted", "15551230000@s.whatsapp.net")).toBe(false);
