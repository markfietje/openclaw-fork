...
```json5
{
  gateway: {
    ...
    controlUi: {
      ...
      // automaticallyFetchFavicons: true, // SSRF-guarded link favicon fetches (default false)
      // remoteImageHosts: ["docs.example.com"], // exact hosts the UI may auto-fetch images/favicons from
