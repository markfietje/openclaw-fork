...
| `state/openclaw.sqlite`                        | Shared runtime state, including model auth profiles and native MCP OAuth access/refresh tokens, dynamic client registration secrets, and discovery state.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `agents/<agentId>/agent/auth-profiles.json`    | Legacy model-auth migration source; doctor imports supported records into shared SQLite.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
- Model auth profiles: `~/.openclaw/state/openclaw.sqlite` (`auth_profile_stores`)
